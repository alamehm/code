...
var viewblocks = {
  ...
  hideNotAllowedOption: function hideNotAllowedOption() {
    ...
    case actions.show_message:
      ...
      $(uiSelectors.settingsFields).filter('[data-field-name="toggle"]').show();
      break;
    }
    ...
    $(uiSelectors.settingsFields).filter('[data-field-name="tag"]').show();
    $(uiSelectors.settingsFields).filter('[data-field-name="toggle"]').show();
...
function FlowControlGoto(runtime, element, options) {
  ...
  settings.message = options.message + options.tag + "tag2 :" + options.tag2 + " score : "+ options.score ;
  settings.inStudioRuntime = options.in_studio_runtime;
//  settings.toggle=true;
//  var handlerUrl2 = runtime.handlerUrl(element, 'toggle_button');
